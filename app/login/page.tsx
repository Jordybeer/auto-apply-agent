...
export default function LoginPage() {
  ...
  return (
    /* No hardcoded background — inherits body/var(--bg) so ambient orbs show through */
    <div className="min-h-screen flex flex-col items-center justify-center px-6 gap-8">
      ...
      <motion.div {...fadeUp(0.18)} className="w-full max-w-sm space-y-3">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.96 }}
          transition={springTap}
          className="w-full flex items-center justify-center gap-3 text-white text-sm font-medium py-3 px-4 rounded-xl glass-card"
        >
