  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 gap-8">
      ...
      <motion.div {...fadeUp(0.18)} className="w-full max-w-sm space-y-3">
        ...
        {/*
          GitHub — adapts to theme:
          dark mode  → outline (transparent bg, white border+text) so it doesn't merge with the navy bg
          light mode → solid dark (#24292e) which contrasts well on a light surface
        */}
        <motion.button
          ...
          transition={springTap}
          className="w-full flex items-center justify-center gap-3 text-sm font-medium py-3 px-4 rounded-xl
            [data-theme=dark_&]:bg-transparent
            [data-theme=dark_&]:text-white
            [data-theme=dark_&]:border
            [data-theme=dark_&]:border-white/25
            [data-theme=light_&]:bg-[#24292e]
            [data-theme=light_&]:text-white"
          style={{
            background: 'var(--github-btn-bg)',
            color: 'var(--github-btn-text)',
            border: 'var(--github-btn-border)',
          }}
        >
          <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24"
            fill="currentColor">
